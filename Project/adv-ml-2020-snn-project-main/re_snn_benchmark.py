...
# print('assignments_train', assignments.shape)
...
# print('spike_record_train', spike_record.shape)
# train the network
print("\nBegin training.\n")
...
for step, batch in enumerate(train_dataloader):
    ...
    # print("Inputs Device:", inputs["X"].device)
    ...
    if step % update_steps == 0 and step > 0:
        ...
        # print("Spike Record Device:", spike_record.device)
...
# print('assignments_test', assignments.shape)
...
for step, batch in enumerate(test_dataloader):
    ...
    # print('spike_record_test', spike_record.shape)
